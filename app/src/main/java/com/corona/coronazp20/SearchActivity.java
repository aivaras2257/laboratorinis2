...
public class SearchActivity extends AppCompatActivity {
    public static final String MARGARITA_API = "https://www.thecocktaildb.com/api/json/v1/1/search.php?s=";
    ...
    protected void onNewIntent(Intent intent) {
        ...
        if (Intent.ACTION_SEARCH.equals(intent.getAction())) {
            ...
            ArrayList<Margarita> margaritaListByCountry = JSON.getMargaritaListQuery(margaritaList, query);
